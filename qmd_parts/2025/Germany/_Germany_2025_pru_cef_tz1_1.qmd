...
- Significantly lower than planned cost of capital (-8.8%), which are understood to mainly reflect the fact that actual costs of capital are netted off using an *"interest income from temporarily invested fixed deposits"* (see also the analysis of Regulatory Result for details).
