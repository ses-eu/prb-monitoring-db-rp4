...
### [**Unit cost**](`r params$home_address`/about.html#cost-efficiency---unit-costs-ducaucu-kpi1-for-en-route-charging-zones-and-kpi2-for-terminal-charging-zones) `r if (params$country != params$rp_full & cztype != "terminal") "(KPI#1)"`
