...
path <- sprintf("./qmd_parts/%s_cef_%s%d_1.qmd", country, cz_short, czindex)
...
path <- sprintf("./qmd_parts/%s_cef_%s%d_2.qmd", country, cz_short, czindex)
...
path <- sprintf("./qmd_parts/%s_cef_%s%d_3.qmd", country, cz_short, czindex)
