...
## Environment - Vertical flight efficiency (VFE) (PI#3) 
[to be added]

## Environment - Additional taxi-out time (AXOT) (PI#4), Additional taxi-in time (AXOT) (PI#5) & Arrival Sequencing and Metering Area (ASMA) time (PI#6)
...
## Environment - Average duration in climb (PI#7) and descent (PI#8)
...
- ERSA (PI#9): The effective use of reserved or segregated airspace;
-	RAI (PI#10): The rate of planning via available airspace structures, including reserved or segregated airspace and conditional routes; and
-	RAU (PI#11): The rate of using available airspace structures, including reserved or segregated airspace and conditional routes.
...
Two other indicators are defined by Implementing Regulation 2019/317 as capacity performance indicators at en route level: 

-  Percentage of en-route ATFM delay occurring when daily throughput was above expected daily traffic (PI#4); and
-  Average daily peak throughput (PI#5)

In addition to these, the evolution of the number of air traffic control officers (ATCOs) in operations (OPS) expressed as full-time equivalents (FTEs), and the sum of sector-opening hours provided by the ANSPs is also monitored.
...
Three other indicators are defined by Implementing Regulation 2019/317 as capacity performance indicators at terminal level: 
