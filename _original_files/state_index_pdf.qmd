...
### Vertical flight efficiency (VFE) (PI#3)
...
### Percentage of en route ATFM delay occurring when daily throughput was above expected daily traffic (PI#4)

```{r chart_level2_cap_perc_delay_above, eval=(params$country != "Luxembourg")}
...
### Average daily peak throughput (PI#5)

```{r chart_level2_cap_peak_tp, eval=(params$country != "Luxembourg")}
