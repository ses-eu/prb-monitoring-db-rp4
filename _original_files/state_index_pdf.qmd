...
```{r env_trm_nsa_axot, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
...
```{r env_trm_nsa_axit, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
...
```{r env_trm_nsa_asma, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
...
`\biggertext{Focus on average duration in climb and descent}`{=latex}

```{r env_trm_nsa_vfed, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
...
```{r env_trm_nsa_vfec, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
...
```{r cap_ert_nsa_atfm, eval=(params$no_ecz != 0)}
#| echo: false
#| output: asis
...
```{r cap_trm_nsa_atfm, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
...
```{r cap_trm_nsa_slot, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
...
```{r cap_trm_nsa_pddelay, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
...
```{r cap_trm_nsa_acdelay, eval=(params$no_tcz != 0)}
#| echo: false
#| output: asis
