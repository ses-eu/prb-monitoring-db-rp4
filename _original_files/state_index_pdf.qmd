...
for (i in seq_len(n)) {
  path <- sprintf("./_cost-efficiency-er%d-1.qmd", i)
  if (file.exists(path)) {
...
for (i in seq_len(n)) {
  path <- sprintf("./_cost-efficiency-tz%d-1.qmd", i)
  if (file.exists(path)) {
    cat(readLines(path, warn = FALSE), sep = "\n")
    cat("\n\n")
  } else {
...
<!-- {{< include ./_cost-efficiency-er2-1.qmd >}} -->

<!-- {{< include ./_cost-efficiency-tz1-1.qmd >}} -->
<!-- {{< include ./_cost-efficiency-tz2-1.qmd >}} -->
