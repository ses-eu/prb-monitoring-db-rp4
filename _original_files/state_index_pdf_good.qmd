...
```{r table_level2_saf_autotools, eval=(year_folder != params$rp_summary_year)}
#| file: R/table_level2_saf_autotools.R
#| include: false
```


``` {r table_level2_saf_autotools_p, eval=(year_folder != params$rp_summary_year)}
#| echo: false
#| results: asis
cat(make_quarto_latex_table(
...
```{r results = "asis", eval=(year_folder != params$rp_summary_year)}
